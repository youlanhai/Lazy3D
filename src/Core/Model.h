...
///模型基类
    ...
    public:
        ...
        ///获取最终的变换矩阵
        void getCombinedMatrix(Matrix & mat) const;

        ///获得世界矩阵
        const Matrix & getWorldMatrix( void) const { return m_matWorld; }

        ///设置世界矩阵
        void setWorldMatrix(const Matrix & pMat) { m_matWorld = pMat; }
