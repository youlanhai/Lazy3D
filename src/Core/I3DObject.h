...
public:
    ...
    virtual void getWorldMatrix(Matrix4x4 & mat) const;//获得世界矩阵
    virtual void getCameraMatrix(Matrix4x4 & mat) const;//获得相机矩阵

	virtual Matrix4x4 getRotationMatrix();//获得旋转矩阵
	virtual Matrix4x4 getRotationMatrix2();
