...
public:
    ...
    ///朝向某点
    void lookAtPosition(const Math::Vector3 & pos);
    ...
    ///头顶板
    void setTopboard(RefPtr<cTopBoard> pboard){ m_topboard = pboard; }
    RefPtr<cTopBoard> getTopboard(void) const { return m_topboard; }
...
{
public:
    typedef Lazy::VisitPool<EntityPtr>  EntityPool;
